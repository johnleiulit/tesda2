                        ...
                        <div class="col-md-6">
                            @if ($application->payment_proof)
                                ...
                                @if ($application->payment_status === 'submitted')
                                    <div class="mt-2">
                                        <form action="{{ route('admin.payment.verify', $application->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                ...
                                @endif
                            @else
                                <p class="text-muted"><i class="fas fa-info-circle"></i> No payment proof uploaded yet.</p>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        @if ($application->reference_number)
                            ...
                            <form id="referenceForm"
                                ...
                                method="POST" class="d-none d-flex gap-2">
                                @csrf
                                @method('PATCH')
                            ...
                            <form id="referenceForm"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Enter 15-digit reference number" maxlength="15"
                                        pattern="[0-9]{0,15}">
                                    @error('reference_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
