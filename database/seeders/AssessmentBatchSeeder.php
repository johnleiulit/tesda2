...
class AssessmentBatchSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $programs = [
            ...
            // 'BOOKKEEPING NC III' => 11,
            // 'EVENTS MANAGEMENT SERVICES NC III' => 9,
            'TOURISM PROMOTION SERVICES NC II' => 8,
            // 'PHARMACY SERVICES NC III' => 20,
        ];
    ...
    private function createApplicantsForProgram($ncProgram, $numberOfApplicants)
    {
        ...
        for ($i = 1; $i <= $numberOfApplicants; $i++) {
            $user = User::create([
                ...
                'email' => "{$programCode}.applicantl{$i}@test.com",
