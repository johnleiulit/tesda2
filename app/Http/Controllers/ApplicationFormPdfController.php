   ...
   private function formatParentGuardianAddress($app)
    {
        ...
        if ($app->parent_guardian_barangay) $firstLine[] = $app->parent_guardian_barangay;
        
        // Second line: district, city, province, region
        $secondLine = [];
        if ($app->parent_guardian_district) $secondLine[] = $app->parent_guardian_district;
        if ($app->parent_guardian_city) $secondLine[] = $app->parent_guardian_city;
        if ($app->parent_guardian_province) $secondLine[] = $app->parent_guardian_province;
        if ($app->parent_guardian_region) $secondLine[] = $app->parent_guardian_region;
